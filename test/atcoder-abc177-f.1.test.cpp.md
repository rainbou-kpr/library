...
data:
  ...
  bundledCode: "#line 1 \"test/atcoder-abc177-f.1.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc177/tasks/abc177_f\"\
    ...
    \ lazy_segtree::Min<int>, lazy_segtree::MaxLimit<int>, int, Mapping, Composition,\
    \ lazy_segtree::MaxLimit<int>> seg(std::vector<int>(w, 0));\n    for(int i = 0;\
  ...
  requiredBy: []
  timestamp: '2023-05-05 00:04:44+09:00'
