...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo-lca.1.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/lca\"\
    \n\n#include <iostream>\n\n#line 2 \"cpp/tree.hpp\"\n\n/**\n * @file tree.hpp\n\
    \ * @brief \u6728\u306E\u6C4E\u7528\u30C6\u30F3\u30D7\u30EC\u30FC\u30C8\n*/\n\n\
    ...
    \       }\n    }\n};\n#line 6 \"test/yosupo-lca.1.test.cpp\"\n\nint main(void)\
    \ {\n    std::cin.tie(nullptr);\n    std::ios::sync_with_stdio(0);\n    int n,\
    \ q; std::cin >> n >> q;\n    std::vector<int> par(n-1);\n    for(int i = 0; i\
    \ < n-1; i++) std::cin >> par[i];\n    DoublingClimbTree tree = RootedTree(par,\
    \ 0).build_lca();\n    while(q--) {\n        int u, v; std::cin >> u >> v;\n \
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/lca\"\n\n#include <iostream>\n\
    ...
    \ tree = RootedTree(par, 0).build_lca();\n    while(q--) {\n        int u, v;\
    \ std::cin >> u >> v;\n        std::cout << tree.lca(u, v) << '\\n';\n    }\n}"
  dependsOn:
  - cpp/tree.hpp
  - cpp/graph.hpp
  ...
  verifiedWith: []
documentation_of: test/yosupo-lca.1.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo-lca.1.test.cpp
- /verify/test/yosupo-lca.1.test.cpp.html
