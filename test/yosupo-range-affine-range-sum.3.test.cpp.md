...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo-range-affine-range-sum.3.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/range_affine_range_sum\"\n\n#include\
    ...
    #line 8 \"test/yosupo-range-affine-range-sum.3.test.cpp\"\n\nint main(void) {\n\
...
layout: document
redirect_from:
- /verify/test/yosupo-range-affine-range-sum.3.test.cpp
- /verify/test/yosupo-range-affine-range-sum.3.test.cpp.html
